...
@Component({
  ...
  styleUrl: './manage-committee.component.css',
})
export class ManageCommitteeComponent {
  ...
  ngOnInit(): void {
    ...
    this.searchControl.valueChanges
      ...
      .subscribe((searchQuery) => {
        this.loadUsers(this.currentPage, this.rows, 5, searchQuery);
      });
  ...
  onPageChange(page: number): void {
    ...
    this.loadUsers(this.currentPage, this.rows, 5, this.searchControl.value);
  }
        ...
        this.userService.update(userFormData).subscribe({
          next: () => {
            ...
            this.messageService.add({
              severity: 'success',
              summary: 'Éxito',
              detail: 'Comité actualizado correctamente',
            });
          },
          error: (err) => {
        ...
        this.userService.create(userFormData).subscribe({
          next: () => {
            ...
            this.messageService.add({
              severity: 'success',
              summary: 'Éxito',
              detail: 'Comité creado correctamente',
            });
          },
          error: (err) => {
